...
idx = 1 # index of the test trajectory (e.g., idx = 18111)
exclude_scp_cvx = False
exclude_scp_DT = False

for i in range(1,200):
    print("idx: ", idx)
    FileName = 'SCP_run_index_' + str(idx) + '.npz'
    LocationPath = os.path.join(os.path.expanduser('~'), 'Desktop', 'ML Formation Flight', 'cases')
    Fullpath = os.path.join(LocationPath, FileName)
    ...
    if saveFiles:
        np.savez(Fullpath, reference_oe=oe_0_ref, ROE_0=states_roe_scp_cvx[:,0], Rtn_0=states_rtn_scp_cvx[:,0], actions=actions_scp_cvx, time_hrz_trg=time_hrz_trg, states = states_roe_scp_cvx, rtn = states_rtn_scp_cvx, cost = la.norm(actions_scp_DT, axis=0).sum())
...
# # CVX
# print(f"\nws_cvx Initial state\n ROE {states_roe_ws_cvx[:,0]}\n Rtn {states_rtn_ws_cvx[:,0]}")
# print('Burns CVX')
# print('Number of burns CVX:', cvx_burns.size)
# print(actions_cvx[:,cvx_burns].T)
# print("Burn times CVX", time_hrz_trg[cvx_burns])
# print(f"ws_cvx Final state\n ROE {states_roe_ws_cvx[:,-1]}\n Rtn {states_rtn_ws_cvx[:,-1]}")

# # SCP-CVX
# print(f"\nws_scp_cvx Initial state\n ROE {states_roe_scp_cvx[:,0]}\n Rtn {states_rtn_scp_cvx[:,0]}")
# print('Number of burns SCP-CVX:', cvx_scp_burns.size)
# print('Burns SCP-CVX')
# print(actions_scp_cvx[:,cvx_scp_burns].T)
# print("Burn times SCP-CVX", time_hrz_trg[cvx_scp_burns])
# print(f"ws_scp_cvx Final state\n ROE {states_roe_scp_cvx[:,-1]}\n Rtn {states_rtn_scp_cvx[:,-1]}")

# SCP_DT
# print(f"\nscp_DT Initial state\n ROE {states_roe_scp_DT[:,0]}\n Rtn {states_rtn_scp_DT[:,0]}")
# print('Number of burns SCP-DT:', scp_DT_burns.size)
# print('Burns SCP-DT')
# print(actions_scp_DT[:,scp_DT_burns].T)
# print("Burn times SCP-DT", time_hrz_trg[scp_DT_burns])
# print(f"scp_DT Final state\n ROE {states_roe_scp_DT[:,-1]}\n Rtn {states_rtn_scp_DT[:,-1]}")
